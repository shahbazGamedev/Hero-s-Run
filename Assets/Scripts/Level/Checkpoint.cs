...
public class Checkpoint : MonoBehaviour {
	...
	void activateCheckpoint ()
	{
		...
		AchievementDisplay.achievementDisplay.activateDisplayFairy( LevelManager.Instance.getCurrentLevelName() + ": " + LocalizationManager.Instance.getText("CHECKPOINT_REACHED"), 0.35f, 5.5f );
	}
}
