...
public class PlayerInput : PunBehaviour {
	...
	private void handleKeyboard()
	{
		...
		{
			GameObject.FindObjectOfType<CardHandler>().activateCard( this.photonView, CardName.Sentry, GameManager.Instance.playerProfile.getUserName(), 5 );
		}
		...
		{
			GameObject.FindObjectOfType<CardHandler>().activateCard( this.photonView, CardName.Force_Field, GameManager.Instance.playerProfile.getUserName(), 9 );
		}
