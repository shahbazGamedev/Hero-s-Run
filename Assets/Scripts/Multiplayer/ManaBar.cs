...
public class ManaBar : MonoBehaviour {
	...
	const int MAX_MANA_POINT = 10;
	const int MIN_MANA_POINT = 0;
	const int START_MANA_POINT = 5;
	const float MANA_REFILL_RATE = 2.8f; //Seconds needed to gain 1 mana point
