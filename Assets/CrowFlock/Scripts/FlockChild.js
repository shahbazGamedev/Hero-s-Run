...
function Update() {
	...
	transform.GetChild(0).transform.localEulerAngles.x = Mathf.LerpAngle(transform.GetChild(0).transform.localEulerAngles.x, -transform.localEulerAngles.x, _lerpCounter * Time.deltaTime * .25);
	else
	transform.GetChild(0).transform.localEulerAngles.x = Mathf.LerpAngle(transform.GetChild(0).transform.localEulerAngles.x, 0, _lerpCounter * Time.deltaTime * .25);
}
