...
function OnGUI () {
	...
	if(GUI.Button(Rect(20,80,125,18),"Destroy")){
		_flockController.destroyBirds();
		}
	GUI.Label(Rect(20,100,125,18),"Bird Amount: " + _flockController._childAmount);
	 _flockController._childAmount = GUI.HorizontalSlider(Rect (20, 120, 125, 18), _flockController._childAmount, 0.0f , 250.0f);
}